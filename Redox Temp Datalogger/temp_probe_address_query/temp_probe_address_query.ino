...
void setup(void)
{
  ...
  if (!sensors.getAddress(probe3, 2)) Serial.println("Unable to find address for Device 0");
  if (!sensors.getAddress(probe4, 3)) Serial.println("Unable to find address for Device 1");
  ...
  Serial.print(sensors.getResolution(probe3), DEC);
  Serial.println();

  Serial.print("Device 3 Resolution: ");
  Serial.print(sensors.getResolution(probe4), DEC);
  Serial.println();
}
